...
def test_count_substrings(input, search_for, expected):
    from challenges.c024_count_substrings import count_substrings, count_substrings_v2
...
def test_count_substrings_char_reusable(input, search_for, expected):
    from challenges.c024_count_substrings import count_substrings_char_reusable
    assert count_substrings_char_reusable(input, search_for) == expected
