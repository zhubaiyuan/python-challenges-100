...
def list_add_v2(values1, values2):
    result = []
    carry = 0
...
def list_add_v3(values1, values2):
    result = []
    carry = 0
...
def list_add_v4(values1, values2):
    result = []
    carry = 0
    idx1 = len(values1) - 1
    idx2 = len(values2) - 1
...
def main():
    ...
    print(list_add_v2([1, 2, 3], [4, 3, 2]))
    print(list_add_v2([1, 2, 3, 4, 5, 6], [6, 5, 4, 3, 2, 1]))
    print(list_add_v2([9, 9, 9], [9, 9, 9]))
    print(list_add_v2([1, 2, 3], [1, 4, 3, 2]))

    print(list_add_v4([1, 2, 3, 4], [7, 7, 7, 6, 5, 4, 3]))
