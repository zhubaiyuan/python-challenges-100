...
def main():
    print(max_revenue([255, 260, 250, 240, 228, 270, 300, 210, 245]))
    print(max_revenue([0, 10, 20, 30, 40, 50, 60, 70]))
    print(max_revenue([70, 60, 50, 40, 30, 20, 10, 0]))
    print(max_revenue([]))

    print(max_revenue_v2([255, 260, 250, 240, 228, 270, 300, 210, 245]))
    print(max_revenue_v2([0, 10, 20, 30, 40, 50, 60, 70]))
    print(max_revenue_v2([70, 60, 50, 40, 30, 20, 10, 0]))
    print(max_revenue_v2([]))
