...
def array_split_v2(values, reference_element):
...
def array_split_v3(values, reference_element):
    low = 0
    high = len(values) - 1
    while low < high:
...
def main():
    ...
    print(array_split_v2([4, 7, 1, 20], 9))
    print(array_split_v2([3, 5, 2], 7))
    print(array_split_v2([2, 14, 10, 1, 11, 12, 3, 4], 7))
    print(array_split_v2([3, 5, 7, 1, 11, 13, 17, 19], 11))

    print(array_split_v4([9, 4, 7, 1, 20]))
    print(array_split_v4([7, 3, 5, 2]))
    print(array_split_v4([7, 2, 14, 10, 1, 11, 12, 3, 4]))
    print(array_split_v4([11, 3, 5, 7, 1, 11, 13, 17, 19]))

    print(array_split_v5([9, 4, 7, 1, 20]))
    print(array_split_v5([7, 3, 5, 2]))
    print(array_split_v5([7, 2, 14, 10, 1, 11, 12, 3, 4]))
    print(array_split_v5([11, 3, 5, 7, 1, 11, 11, 13, 17, 19]))
